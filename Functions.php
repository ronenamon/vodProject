<?php
    ...
    // Developer: Ronen Amon At Apache/2.4.6 (CentOS) OpenSSL/1.0.1e-fips
    //A DBOperations class instance is created and stored in $db private variable via constructor.
...
public function __construct() {
      ...
      $this -> db = new DBOperations();//instance of Dbop
